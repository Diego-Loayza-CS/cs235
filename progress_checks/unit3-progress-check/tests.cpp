...
TEST(performance, 20)
{
    ...
    timer.stop();
    cout << "Calibration: " << timer.nanoseconds() << endl;
    ...
    cout << "MergeSort on " << N << " items: " << merge_timer.nanoseconds() << endl;
    auto ratio = (merge_timer.nanoseconds() / timer.nanoseconds());
    cout << "Ratio: " << ratio << endl;
    ASSERT(ratio < 4000, "MergeSort time must be < 4000x the calibration time");
}
